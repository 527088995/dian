...
public class ControllerConfig {
    ...
    public void init() {
        ...
        imports.add(contextConfig.getCoreBasePackage() + ".common.constant.state.DelFlag");
        ...
        imports.add("com.stylefeng.guns.core.page.LayuiPageFactory");
        imports.add("com.stylefeng.guns.modular.system.warpper.BaseWrapper");
        imports.add("cn.hutool.core.bean.BeanUtil");
        imports.add("com.stylefeng.guns.core.util.ToolUtil");
        imports.add("com.stylefeng.guns.core.exception.ServiceException");
